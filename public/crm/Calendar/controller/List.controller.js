sap.ui.define(
	...
	function (Controller, MessageToast, Fragment, JSONModel, ChartFormatter, FeedItem, AjaxUtils,  MessageBox) {
		"use strict";
		...
		theClass.prototype.onInit = function () {
			...
			oModel.setData({
				...
				people: [{
					pic: "https://ui5.sap.com/test-resources/sap/ui/documentation/sdk/images/John_Miller.png",
					name: "John Miller",
					role: "team member",
					appointments: [
						{
					...
					{
						pic: "https://ui5.sap.com/test-resources/sap/ui/documentation/sdk/images/Donna_Moore.jpg",
						name: "Donna Moore",
						role: "team member",
						appointments: [
							{
		...
		theClass.prototype.handleAppointmentSelect=function (oEvent) {
		...
		theClass.prototype.handleSelectionFinish=function(oEvent) {
